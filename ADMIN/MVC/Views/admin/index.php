                ...
                if (isset($_SESSION['isLogin_Admin']) && $_SESSION['isLogin_Admin'] == true) {
                  ...
                  switch ($mod) {
                    ...
                    case 'sanpham':
                      switch ($act) {
                        ...
                        case 'edit':
                          ...
                          break;
                        case 'sp_nl':
                          require_once('MVC/views/sanpham/sp_nl.php');
                          break;
                        default:
                          require_once('MVC/views/sanpham/list.php');
                          break;
                    ...
                    case 'loainguyenlieu':
                      switch ($act) {
                        case 'list':
                          require_once('MVC/views/loainguyenlieu/list.php');
                          break;
                        case 'add':
                          require_once('MVC/views/loainguyenlieu/add.php');
                          break;
                        case 'detail':
                          require_once('MVC/views/loainguyenlieu/detail.php');
                          break;
                        case 'edit':
                          require_once('MVC/views/loainguyenlieu/edit.php');
                          break;
                        default:
                          require_once('MVC/views/loainguyenlieu/list.php');
                          break;
                    ...
                    case 'nguyenlieu':
                      switch ($act) {
                        case 'list':
                          require_once('MVC/views/nguyenlieu/list.php');
                          break;
                        case 'add':
                          require_once('MVC/views/nguyenlieu/add.php');
                          break;
                        case 'detail':
                          require_once('MVC/views/nguyenlieu/detail.php');
                          break;
                        case 'edit':
                          require_once('MVC/views/nguyenlieu/edit.php');
                          break;
                        default:
                          require_once('MVC/views/nguyenlieu/list.php');
                          break;
